...
​		面试官你好，我叫曾博佳，毕业于北京师范大学珠海分校软件工程专业。接下来我简单介绍下自己的开发能力，开发语言上主要以Java语言为主，有扎实的Java基础和良好的编码风格，有一定并发编程、分布式开发经验。开发模式上熟悉以SpringBoot、SpringCloud为主的Web开发模式。最近有了解到Go语言，也有意愿学习和转语言。我目前有两年的工作经验，第一年是在一家国际航运公司做编排系统开发，特点是采用敏捷开发、微服务开发，采用服务网格做容器编排及部署。第二年是在一家交通行业公司做高速公路及服务区相关业务的开发，它的特点主要是微服务开发、基础设备对接与数据采集。最后做一个自我评价，我自认为是一个比较上进且有一定自律能力的人，在过去的团队工作中，也担任过开发小组长这样的角色，有良好的抗压能力及沟通能力，我个人也很乐于向优秀的人学习，也非常希望能够加入到金山，跟优秀的人一起做有挑战的事。以上就是我的自我介绍。
...
- Kafka用于接收情报板、卡口车辆抓拍信息及其他设备采集的消息，用于与系统服务的解耦，可用做流量控制
...
> HashMap为什么是线程不安全的？
>
> - Put：元素操作没有加锁，存在并发覆盖问题，例如put方法，并发下对空元素的位置添加元素，会出现覆盖问题
...
#### 1. PCM：分布式事务、数据库、分布式锁

微服务：DDD微服务拆分，Swif方法论
...
数据迁移：**分布式事务**、数据量级、MySQL

- 分布式事务：强一致性事务
- 数量级：**千万级数据**按照业务（checkpoint）进行横向拆分到不同服务中
- MySQL：**分库、索引**
...
- Netty：NIO开发、TCP协议
- 设计模式：工厂模式-情报板协议包，其他的例如单例模式、模版方法模式、适配器模式
...
- 规则编排：类似于Java线程的状态转化，订单也有其生命周期，状态与Java线程状态类型，而往往航运中的订单状态的转换比较复杂，影响状态的因素又比较多，我们很难通过编写硬代码去实现“某个变量变化了，去链式的更新其状态”（即变化本身也会作为变量去影响其他），drools则封装了底层的链路，我们只需要编写好规则：【变量、行为】即可
