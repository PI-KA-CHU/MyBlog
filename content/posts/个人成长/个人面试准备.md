...
>
>- 唤醒处理：wait-notify/notifyAll（有顺序要求，notify后需要获取锁），park-unpark（二元信号量，类似于许可证，无顺序要求，由于不释放锁，所以unpark后立刻执行）
>
>  
>
...
> 缺点：
>
> - 由于写操作的时候，需要拷贝数组，会消耗内存，如果原数组的内容比较多的情况下，可能导致young gc或者full gc（大对象创建）
